...
def main(recreate: bool):
    ...
    if recreate:
        LandRegistryBase.metadata.tables['land_registry_2.pp_complete_archive_file_log'].drop(engine)

    LandRegistryBase.metadata.tables['land_registry_2.pp_complete_archive_file_log'].create(engine)
