...
def main(recreate: bool):
    ...
    if recreate:
        LandRegistryBase.metadata.tables['land_registry_2.pp_monthly_data'].drop(engine)

    LandRegistryBase.metadata.tables['land_registry_2.pp_monthly_data'].create(engine)
